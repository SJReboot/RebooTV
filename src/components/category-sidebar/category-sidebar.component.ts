        ...
        <ul class="space-y-1">
          <li>
            <a
              ...
              [class.bg-sky-500/20]="selectedCategoryId() === null && !isMassEditing()"
              [class.text-sky-300]="selectedCategoryId() === null && !isMassEditing()"
              [class.font-semibold]="selectedCategoryId() === null && !isMassEditing()"
              [class.text-gray-400]="selectedCategoryId() !== null || isMassEditing()"
              [class.hover:bg-gray-700/50]="selectedCategoryId() !== null && !isMassEditing()"
              [class.hover:text-white]="selectedCategoryId() !== null && !isMassEditing()"
              [class.cursor-not-allowed]="isMassEditing()"
              [class.opacity-50]="isMassEditing()"
              (click)="onSelect(null)">
          ...
          @for (category of categoriesForDisplay(); track category.id) {
            <li>
              <div
                ...
                [class.bg-sky-500/20]="category.id === selectedCategoryId() && !isMassEditing()"
                [class.text-sky-300]="category.id === selectedCategoryId() && !isMassEditing()"
                [class.font-semibold]="category.id === selectedCategoryId() && !isMassEditing()"
                [class.text-gray-400]="!(category.id === selectedCategoryId() && !isMassEditing())"
                [class.hover:bg-gray-700/50]="!(category.id === selectedCategoryId() && !isMassEditing())"
                [class.hover:text-white]="!(category.id === selectedCategoryId() && !isMassEditing())"
                [class.bg-sky-600/30]="selectedForEdit().has(category.id)"
